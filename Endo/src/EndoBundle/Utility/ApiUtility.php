...
class ApiUtility
{
    ...
    public function generateErrorResponse($error, $debug = false)
    {
        ...
        // Response body
        $json['error'] = intval($error);
        $json['description'] = self::getErrorDescription($error);
    ...
    public function generateResponse($data = false, $debug = false)
    {
        ...
        // Response body
        $json['error'] = 0;
        $json['description'] = self::getErrorDescription(0);
        if (is_array($data)) {
            $json['data'] = $data;
        }
    ...
    private function getErrorDescription($error)
    {
        ...
        switch($error){
            ...
            case 12:
                ...
                break;
            case 13:
                $description = 'User already have this campaign active';
                break;
            case 14:
            ...
            case 15:
                ...
                break;
            case 16:
                $description = 'No events fond this week';
                break;
            case 17:
                $description = 'This event is already favorite';
                break;
            case 18:
            ...
            case 19:
                ...
                break;
            case 20:
                $description = 'Event already scheduled';
                break;
            case 21:
                $description = 'Invalid eventLog date';
                break;
            case 22:
                $description = 'Invalid rating number';
                break;
            case 80:
                $description = 'Conekta: Unknown API error';
                break;
            case 81:
                $description = 'Conekta: Invalid plan / not registered';
                break;
            case 82:
                $description = 'Conekta: Invalid card token';
                break;
            case 83:
                $description = 'Conekta: No valid Customer Account found';
                break;
            case 99:
